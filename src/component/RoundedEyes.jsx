    ...
    <div className="w-full h-screen overflow-hidden">
      ...
      >
        <div className="absolute inset-0 flex justify-center items-center">
          <div className="flex items-center justify-center w-32 h-32 md:w-48 md:h-48 rounded-full bg-zinc-100">
            <div className="relative w-2/3 h-2/3 rounded-full bg-zinc-900 flex items-center justify-center">
              <p className="text-xl md:text-2xl font-semibold font-['Text Founders Grotesk X-Cond SmBd'] text-zinc-100">play</p>
              <div
                style={{
                  transform: `translate(-50%, -50%) rotate(${rotate}deg)`,
                }}
                className="line absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-10 md:h-14"
              >
                <div className="w-6 md:w-10 h-6 md:h-10 rounded-full bg-zinc-100"></div>
              </div>
            </div>
          </div>
        </div>
