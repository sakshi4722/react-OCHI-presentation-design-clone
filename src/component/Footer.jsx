...
const Footer = () => {
  return (
    <div className="flex flex-col md:flex-row gap-5 w-full min-h-screen bg-zinc-900 p-10 md:p-20">
      <div className="w-full md:w-1/2 flex flex-col justify-between">
        <div className="heading font-['Text Founders Grotesk X-Cond SmBd'] font-semibold">
          <h2 className="text-4xl md:text-[8vw] uppercase leading-none -mb-4 md:-mb-10">eye-</h2>
          <h2 className="text-4xl md:text-[8vw] uppercase leading-none mt-2 md:mt-4">opening</h2>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-full md:w-1/2 capitalize">
        <h2 className="text-2xl md:text-4xl uppercase leading-none -mb-4 md:-mb-10">
          presentations
        </h2>
        <div className="details mt-2 md:mt-32 text-sm md:text-base">
          <p>Social Media:</p>
          <ul className="flex flex-col gap-y-1 tracking-wide">
            <li>
              <a className="underline" href="#">
                Instagram
              </a>
