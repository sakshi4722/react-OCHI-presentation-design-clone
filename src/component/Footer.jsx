...
//         <div className="heading font-['Text Founders Grotesk X-Cond SmBd'] font-semibold">
//           <h2 className="text-[8vw] uppercase leading-none -mb-10">eye-</h2>
//           <h2 className="text-[8vw] uppercase leading-none mt-4">opening</h2>
//         </div>
//         <svg
//           width="72"
//           height="30"
...
//         <h2 className="text-[7vw] uppercase leading-none -mb-10">
//           presetations </h2>
//           <div className="dets text-sm mt-32">
//             <p>s:</p>
//             <ul className="flex flex-col gap-y-[1px] tracking-wide text-lg">
//               <li>
//                 <a className="underline" href="#">
//                   intagram
//                 </a>
//               </li>
//               <li><a className="underline" href="#">
//                   facebook
//                 </a></li>
//               <li><a className="underline" href="#">
//                   linkdin
...
const Footer = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-5 w-full min-h-screen bg-zinc-900 p-5 md:p-10 lg:p-20">
      <div className="w-full lg:w-1/2 h-full flex flex-col justify-between">
        <div className="heading font-['Text Founders Grotesk X-Cond SmBd'] font-semibold">
          <h2 className="text-[15vw] md:text-[10vw] lg:text-[8vw] uppercase leading-none -mb-4 md:-mb-10">
            eye-
          </h2>
          <h2 className="text-[15vw] md:text-[10vw] lg:text-[8vw] uppercase leading-none mt-2 md:mt-4">
            opening
          </h2>
        </div>
        <svg
      ...
      <div className="w-full lg:w-1/2 capitalize">
        <h2 className="text-[15vw] md:text-[10vw] lg:text-[7vw] uppercase leading-none -mb-4 md:-mb-10">
          presetations
        </h2>
        <div className="dets text-sm mt-10 md:mt-32">
          <p>s:</p>
          <ul className="flex flex-col gap-y-1 tracking-wide text-lg">
            <li>
              <a className="underline" href="#">
                instagram
              </a>
